...
public interface TransactionsService {
  ...
  /**
   * Blocks item renewal for a DCB transaction. This prevents the item from being renewed until unblocked.
   *
  ...
  /**
   * Unblocks item renewal for a DCB transaction. This allows the item to be renewed again after being blocked.
   *
   * @param dcbTransactionId unique identifier of the DCB transaction
   */
