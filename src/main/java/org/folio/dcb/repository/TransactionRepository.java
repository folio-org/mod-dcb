...
public interface TransactionRepository extends JpaRepository<TransactionEntity, String> {
  ...
  @Query(value = "SELECT * FROM transactions where item_id = :itemId AND status = 'EXPIRED' AND role = 'LENDER'", nativeQuery = true)
  List<TransactionEntity> findExpiredLenderTransactionsByItemId(@Param("itemId") UUID itemId);
