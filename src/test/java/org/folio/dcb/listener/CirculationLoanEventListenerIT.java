...
class CirculationLoanEventListenerIT extends BaseTenantIntegrationTest {
  ...
  private static final String CHECK_OUT_EVENT_SAMPLE =
      getMockDataAsString("mockdata/kafka/check_out.json");
  private static final String LOAN_EVENT_WITH_OUT_IS_DCB =
      getMockDataAsString("mockdata/kafka/loan_sample_without_isdcb.json");
  private static final String CHECK_OUT_EVENT_SAMPLE_FOR_DCB =
      getMockDataAsString("mockdata/kafka/check_out_dcb.json");
  private static final String CHECK_IN_EVENT_SAMPLE =
      getMockDataAsString("mockdata/kafka/loan_check_in.json");
  private static final String CHECK_IN_DCB_FALSE_LOAN_EVENT_SAMPLE =
      getMockDataAsString("mockdata/kafka/loan_check_in_dcb_false.json");
  private static final String NO_ITEM_ID_EVENT_SAMPLE =
      getMockDataAsString("mockdata/kafka/loan_check_in_no_item_id.json");
  private static final String CHECK_IN_UNDEFINED_SAMPLE =
      getMockDataAsString("mockdata/kafka/loan_undefined.json");
  ...
  void handleCheckingOutForDcbTest() {
    ...
    MessageHeaders messageHeaders = getMessageHeaders();
    when(transactionRepository.findTransactionByItemIdAndStatusNotInClosed(any()))
  ...
  void handleCheckOutEventInBorrowingPickupSelfBorrowingTrueCheckout_positive() {
    ...
    MessageHeaders messageHeaders = getMessageHeaders();
    when(transactionRepository.findSingleTransactionsByItemIdAndStatusNotInClosed(any()))
        .thenReturn(Optional.of(transactionEntity));
    eventListener.handleLoanEvent(CHECK_OUT_EVENT_SAMPLE, messageHeaders);
    verify(transactionRepository).save(any());
  ...
  private static @NotNull TransactionEntity getBorrowingPickupWithSelfBorrowingTransactionEntity(
