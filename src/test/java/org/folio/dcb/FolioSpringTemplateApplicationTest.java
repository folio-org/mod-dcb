...
@SpringBootTest(classes = {DcbApplication.class, FolioSpringTemplateApplicationTest.TestTenantController.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
